            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-user-o"></i> Productos
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <button type="submit"  @click="listPro(1,criterio,buscar)" class="btn btn-dark"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dark modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="valor" id="nombre" name="nombre" class="form-control" placeholder="Valor del Producto">
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-show="accion==0" type="button" @click="regPro" class="btn btn-dark">Guardar</button>
                            <button v-show="accion==1" type="button" @click="actPro" class="btn btn-dark">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
           ...
           //////////////////////(Para las Modales Agregar y Registrar)
            abrirModal(accion,data=[]){
                switch (accion) {
                    ...
                    case 'editar':
                        this.titulo='Editar datos del Producto'
                        this.accion=1;
                        this.idPro= data['id'];
