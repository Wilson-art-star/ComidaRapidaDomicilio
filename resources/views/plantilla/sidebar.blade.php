            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            ...
                            <li class="nav-item" @click="menu=11">
                                <a class="nav-link" href="#"><i class="fa fa-cube"></i>Insumos</a>
                            </li>
                            <li class="nav-item" @click="menu=2">
                                <a class="nav-link" href="#"><i class="fa fa-tags"></i>Tipos de Insumos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-tags"></i>Arreglo</a>
                            </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item" @click="menu=4">
                                <a class="nav-link" href="i#"><i class="fa fa-address-card-o"></i>Datos de Empleados</a>
                            </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="i#"><i class="fa fa-motorcycle"></i>Pedido</a>
                            </li>
                            <li class="nav-item">
